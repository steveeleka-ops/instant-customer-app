      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              DateFormat('d, MMMM y | HH:mm', Get.locale?.toString() ?? 'en').format(DateTime.fromMillisecondsSinceEpoch(this.chat?.time ?? 0)),
    ...
    return Align(
      ...
      child: Column(
        ...
        children: [
          Container(
            decoration: BoxDecoration(
                color: Get.theme.colorScheme.secondary, borderRadius: BorderRadius.only(topRight: Radius.circular(15), bottomLeft: Radius.circular(15), bottomRight: Radius.circular(15))),
            padding: EdgeInsets.symmetric(vertical: 14, horizontal: 14),
            margin: EdgeInsets.symmetric(vertical: 5),
            child: Row(
              mainAxisSize: MainAxisSize.min,
          ...
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 10),
            child: Text(
              DateFormat('HH:mm | d, MMMM y', Get.locale?.toString() ?? 'en').format(DateTime.fromMillisecondsSinceEpoch(this.chat?.time ?? 0)),
              overflow: TextOverflow.fade,
              softWrap: false,
              style: Get.textTheme.bodySmall,
            ),
