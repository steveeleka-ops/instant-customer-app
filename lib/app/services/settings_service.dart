...
class SettingsService extends GetxService {
  ...
  ThemeData getLightTheme() {
    ...
    return ThemeData(
        ...
        brightness: Brightness.light, // Ui.parseColor(setting.value.mainColor),
        ...
        textTheme: GoogleFonts.getTextTheme(
          ...
          primary: Color(0XFFDC6437), //Ui.parseColor(setting.value.mainColor),
          secondary:
              Color(0XFFDC6437), //Ui.parseColor(setting.value.mainColor),
        ).copyWith(secondary: Color(0XFFDC6437)));
  }
  ...
  ThemeData getDarkTheme() {
    ...
    return ThemeData(
        ...
        ).copyWith(secondary: Ui.parseColor(setting.value.mainDarkColor)));
  }
  ...
  ThemeData getWebLightTheme() {
    ...
    return ThemeData(
        ...
        ).copyWith(secondary: Ui.parseColor(setting.value.mainColor)));
  }
