...
class NotificationRepository {
  ...
  Future<bool> sendNotification(List<User> users, User from, String type, String text,String message_id,String userID) {
    return _laravelApiClient.sendNotification(users, from, type, text,message_id,userID);
  }
}
